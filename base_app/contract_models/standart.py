...
dic_const = {'id_sklad': '11111111', 'id_client': '11111111', 'id_postav': '11111111', 'delivery_type': 2}
...
def start(file_name, contract, _dic_const=None, _dic_num_art=None):
    if _dic_const is not None:
        global dic_const
        dic_const = _dic_const
    try:
